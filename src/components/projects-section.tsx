...
const sampleProjects: Project[] = [
  {
    ...
    category: "バックエンド",
    description: "Go言語とKubernetesを使用した大規模ECサイトのマイクロサービス化プロジェクト。高トラフィックに対応できるスケーラブルなアーキテクチャを設計・実装しました。",
    fullDescription: "従来のモノリシックなECサイトを、Go言語によるマイクロサービスアーキテクチャに移行するプロジェクト。Docker、Kubernetes、Redis、PostgreSQLを活用し、1日100万PVに対応できるシステムを構築。CI/CDパイプラインの構築も担当し、開発効率を40%向上させました。",
    technologies: ["Go", "Kubernetes", "Docker", "PostgreSQL", "Redis", "gRPC", "Prometheus", "Grafana", "GitHub Actions"],
